// ------------------------------------- GETS -------------------------------------//
export const GET_BREEDS = 'GET_BREEDS'; // Trae todos las razas
export const GET_TEMPERAMENTS = 'GET_TEMPERAMENTS'; // Trae todos los temperamentos
export const GET_DETAIL = 'GET_DETAIL'; // Trae la info de una sola para el detalle
export const GET_BREED = 'GET_BREED'; //  Trae la info de la busqueda
// ------------------------------------- FILTROS -------------------------------------//
