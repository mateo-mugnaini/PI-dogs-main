...
const [numeroPagina, setNumeroPagina] = useState(1);
    ...
    // console.log (raza, 'AAAAAAAAA')

    return(
        <div className="container-General">
        <div className="container-Cards">
{/* ------------------------------MAPEO DE LAS TARJETAS-----------------------------------------*/}
        {raza.length > 0 && raza.map (e => {
            const tempArray = []
...
{/*-----------------------------------------PAGINADO--------------------------------------------*/}
        <div className="container-Pagination">
            <div>
              <button className="btnPag" onClick={() => setNumeroPagina(numeroPagina - 1)}>BACK</button>
              <button className="btnPag">{numeroPagina}</button>
              <button className="btnPag" onClick={() => setNumeroPagina(numeroPagina + 1)}>NEXT</button>
            </div>
        </div>
